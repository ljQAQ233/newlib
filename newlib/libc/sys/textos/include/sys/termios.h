...
int tcsetwinsize(int __fd, const struct winsize *__wsz);
int tcgetwinsize(int __fd, struct winsize *__wsz);
pid_t tcgetpgrp(int __fd);
speed_t cfgetospeed(const struct termios *__tio);
speed_t cfgetispeed(const struct termios *__tio);
...
int tcsendbreak(int __fd, int __dur);
